...
const apiClient = buildUnitClient('/api/grandmassif');
...
interface GrandMassifModuleProps {
  dataIni: string;
  dataFim: string;
}

export default function GrandMassifModule({ dataIni, dataFim }: GrandMassifModuleProps) {
